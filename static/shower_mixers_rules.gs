/**
 * Shower Mixers Collection Rules - Google Apps Script
...
// Quality Score Fields for Shower Mixers
const QUALITY_SCORE_FIELDS = [
'sku', 'title', 'brand_name', 'valve_type', 'flow_rate', 'pressure_rating', 'material', 'finish'
];

// Column Mappings for Shower Mixers
...
function onEdit(e) {
  try {
    console.log('✅ Shower Mixers sheet edited, processing...');
...
/**
 * Initialize Shower Mixers collection rules
 */
function initializeShowerMixersRules() {
  console.log('🚀 Initializing Shower Mixers collection rules...');
  ...
  console.log('✅ Shower Mixers rules initialized successfully');
}
...
function formatHeaders() {
  ...
  console.log('✅ Headers formatted for Shower Mixers');
}

// Auto-run initialization when script is deployed
initializeShowerMixersRules();
